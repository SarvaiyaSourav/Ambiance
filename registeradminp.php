    ...
    <section class="admin" style="margin-top:50px">
        <section class="register">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-center">Register Requests</h2>
                        <table>
                            <tr>
                                <th>SR.NO</th>
                                <th>Fullname</th>
                            ...
                            error_reporting(0);
                        $search = $_POST['search'];
                        $query = "SELECT * FROM register  WHERE email  LIKE '$search%' OR email  LIKE '%$search' OR email  LIKE '%$search%' ";
                        ...
                        $query = "SELECT * FROM register";
                            ...
                            while ($res = mysqli_fetch_assoc($data)) {
                                ...
                                <tr>
                                    ...
                                    <td>" . $res['password'] . "</td>
                                    <td>
                                    <a href='registerupdate.php?up=" . $res['sr'] . "'><button>Edit</button></a>
                                    </td>
                                    <td class='pencil'>
                                    <a href='deleteregister.php?del=" . $res['mobileno'] . "'><button>Delete</button></a>
                                    </td>
                                    </tr>
                                    ";
                            }
