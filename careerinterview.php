                ...
                <div class="col-lg-4">
                    ...
                    <h1>INTERVIEW'S</h1>
                        ...
                        <div class="content">
                            <table>
                                <tr>
                                    <td><span>THIS WEEK:</span></td>
                                    <td>25</td>
                                </tr>
                                <tr>
                                    <td><span>TOTAL INTERVIEWS:</span></td>
                                    <td>70</td>
                                </tr>
                            </table>
                        </div>
    ...
    <!-- career -->
        ...
        <section class="career">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="text-center">Interiew Requests</h2>
                        <table>
                            <tr>
                                <th>SR.NO</th>
                                <th>FullName</th>
                            ...
                            $query = "SELECT * FROM career WHERE status = 'schedule'";
