...
<head>
  ...
  <title>Project 1 - Read More</title>
  ...
  <div class="container">
    <div class="readmore">
      ...
      <div class="project-details">
        <img onclick="openLightbox(event)" src="https://images.squarespace-cdn.com/content/v1/5c3c4ca8365f02e708cc7c8c/da4f80f3-8b78-4354-a175-8eb45b5229a3/Swiss+Blk+356b+Ubi+Ave+3+-+Kerbe-0242-min.jpg?format=1000w" alt="Project 1 Image 1" style="border-radius: 15px; width: 100%" />
        <div class="phead">
      ...
      <div class="project-images">
        ...
        <img onclick="openLightbox(event)" src="https://images.squarespace-cdn.com/content/v1/5c3c4ca8365f02e708cc7c8c/e8be3666-a1f6-4b87-b849-f6f3d54d0b49/Swiss+Blk+356b+Ubi+Ave+3+-+Kerbe-0232-min.jpg?format=750w" alt="" />
        <img onclick="openLightbox(event)" src="https://images.squarespace-cdn.com/content/v1/5c3c4ca8365f02e708cc7c8c/1ec72895-0219-4b7e-bbd4-1e2ae903239d/Swiss+Blk+356b+Ubi+Ave+3+-+Kerbe-0169-min.jpg?format=1000w" alt="" />
        <img onclick="openLightbox(event)" src="https://images.squarespace-cdn.com/content/v1/5c3c4ca8365f02e708cc7c8c/ad8e4c50-03bc-4fd0-a22f-9385157eb518/Swiss+Blk+356b+Ubi+Ave+3+-+Kerbe-0032-min.jpg?format=1000w" alt="Project 1 Image 3" />
        <!-- Add more images as needed -->
      </div>
      <div class="pbottomsec">
        <a href="portfolio.php#goto1" class="back-link">&larr; Back to Portfolio</a>
