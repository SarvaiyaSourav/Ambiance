  ...
  <head>
    ...
    <style>
      ...
      .bottomoverlay {
        ...
        width: 1400px;
        height: 500px;
        background-color: rgba(0, 0, 0, 0.767); /* Adjust the opacity (last value) as needed */
        border-radius: 5px;
      }
        ...
        <div class="bimg" style="margin-left: 12%">
          <div class="container" style=" height: 700px; width: 700px; overflow: hidden; padding-top: 2%; padding-bottom: 2%">
            <div class="row" style="display: inline; margin: 0">
              ...
              <div class="col-lg-6" style="margin-top: 2%; padding-bottom: 2%">
                <img onclick="openLightbox(event)" src="https://flyingcdn-98ab332c.b-cdn.net/wp-content/uploads/2022/03/ncr-interior-design.jpg" alt="" style="height: 100%; width: 100%" />
              </div>
            </div>
          </div>
        </div>
